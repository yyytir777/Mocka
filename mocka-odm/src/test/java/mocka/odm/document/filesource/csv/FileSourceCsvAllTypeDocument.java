...
@Document
@FileSource("file-source/file_source_all_type.csv")
public class FileSourceCsvAllTypeDocument {
    ...
    public FileSourceCsvAllTypeDocument() {}
    ...
    public String toString() {
        return "FileSourceCsvAllTypeDocument{" +
                "name='" + name + '\'' +
                ", email='" + email + '\'' +
