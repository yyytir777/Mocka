...
public class GenerateTypeChildrenTest {
    ...
    void generate_children_entity() {
        EntityGenerator<GrandParent> generator = generatorFactory.getGenerator(GrandParent.class);
        GrandParent grandParent = generator.generateType(GenerateType.CHILDREN).get();
