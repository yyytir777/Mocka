...
public class RegexParser extends Parser {
	...
	public static final int
		RULE_regex = 0, RULE_expr = 1, RULE_element = 2, RULE_group = 3, RULE_quantifier = 4, 
		RULE_atom = 5, RULE_charClass = 6, RULE_charRange = 7, RULE_classAtom = 8;
	private static String[] makeRuleNames() {
		return new String[] {
			"regex", "expr", "element", "group", "quantifier", "atom", "charClass", 
			"charRange", "classAtom"
		};
	}
	...
	public final CharClassContext charClass() throws RecognitionException {
		...
		enterRule(_localctx, 12, RULE_charClass);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ClassAtomContext classAtom() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_classAtom);
		try {
			setState(68);
			_errHandler.sync(this);
