...
import entityinstantiator.generator.orm.ORMResolver;
...
@DisplayName("entity-instantiator-spring Main Test Code")
public class EntityInstantiatorSpringMainTest {

    @Autowired
    SpringGeneratorFactory springGeneratorFactory;

    @Test
    @DisplayName("Set ORM scan range by the value of 'entity-instantiator.orm.ormType' in application.yaml. If not specified, use bean definition.")
    void get_ormType() {
