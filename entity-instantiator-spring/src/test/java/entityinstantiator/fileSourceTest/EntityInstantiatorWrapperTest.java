...
import entityinstantiator.entity.filesource.xml.Person;
import entityinstantiator.parser.EntityInstantiatorWrapper;
...
class EntityInstantiatorWrapperTest {
    ...
    void unmarshal_xmlElements_into_entity_list() throws Exception {
        ...
        EntityInstantiatorWrapper<Person> wrapper = new EntityInstantiatorWrapper<>();
